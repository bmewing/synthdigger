...
1. Go to **https://github.com/bmewing/synthdigger**.
2. Click **Fork** (top right) → **Create fork**.
3. You now have `https://github.com/YOUR_USERNAME/synthdigger`.

## Step 3 — Use your fork on your computer

If you cloned the original repo back in [[02 Install the App]], point it at your fork
instead so you can deploy from it. From inside the `synthdigger` folder:

```bash
git remote set-url origin https://github.com/YOUR_USERNAME/synthdigger.git
```

(Or clone your fork fresh: `git clone https://github.com/YOUR_USERNAME/synthdigger.git`.)
...
You can see your own copy at `github.com/YOUR_USERNAME/synthdigger`.
